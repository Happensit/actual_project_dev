...
<div id="page-wrapper">
  ...
  <header id="header" role="banner" class="<?php print $secondary_menu ? 'with-secondary-menu': 'without-secondary-menu'; ?>"><div class="section clearfix">
          ...
          <div class="block-auth">
              <ul class="auth">
                  <li><?php print l('Войти', 'login');?></li>
                  <li><?php print l('Зарегистрироваться', 'registration');?></li>
              </ul>
          </div>
          <?php else: ?>
          ...
          <nav id="main-menu" role="navigation" class="navigation">
              <?php $menu_main = menu_tree('main-menu');
              echo render($menu_main);
              ?>
          </nav> <!-- /#main-menu -->
      </div>
        ...
        <?php endif; ?><div id="main-wrapper" class="clearfix">
            <div id="main" role="main" class="clearfix"><?php print $breadcrumb; ?>

                <div id="content" class="column">
                    <div class="section">
                        <?php if ($page['highlighted']): ?><div id="highlighted"><?php print render($page['highlighted']); ?></div><?php endif; ?>
                        <?php print render($title_prefix); ?><?php if ($title): ?><h1 class="title" id="page-title"><?php print $title; ?></h1><?php endif; ?>
                ...
                <?php endif; ?> <?php if ($page['sidebar_second']): ?>
