jQuery(document).ready(function(){
    ...
    jQuery('input#edit-continue').replaceWith('<button type="submit" class="button_flex" name="op" value="РџСЂРѕРґРѕР»Р¶РёС‚СЊ РѕС„РѕСЂРјР»РµРЅРёРµ"><span><span>РћС„РѕСЂРјРёС‚СЊ Р·Р°РєР°Р·</span></span></button>');
