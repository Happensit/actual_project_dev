(function ($) {
    $(document).ready(function() {
        ...
        $('input#edit-submit-lamp-search,input#edit-submit-lamp-search2').replaceWith('<button type="submit" class="button_flex" name="" value="РСЃРєР°С‚СЊ"><span><span>РСЃРєР°С‚СЊ</span></span></button>');
